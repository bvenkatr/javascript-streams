...
Issues:-
	...
	This code works but it's bulky and buffers up the entire data.txt file into memory for every request before
...
Solution:-
    Using streams we can avoid the above problem
